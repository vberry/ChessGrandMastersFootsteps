...
class ChessGameNormal(ChessGame):
    """Version à difficulté moyenne du jeu d'échecs où le joueur a 3 essais pour deviner le coup correct."""
    ...
    def submit_move(self, move): 
        ...
        Retourne le résultat après 3 essais ou si le coup correct est trouvé.
        """
        ...
        if is_correct or self.attempts >= self.max_attempts:
            ...
            # Retourner un message pour encourager à réessayer
            return {
                'is_correct': False,
                'submitted_move': submitted_move_san,
